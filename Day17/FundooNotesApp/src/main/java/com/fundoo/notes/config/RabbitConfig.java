...
public class RabbitConfig {
    ...
    public static final String ACTIVITY_EXCHANGE = "fundoo.activity.exchange";
    public static final String ACTIVITY_QUEUE = "fundoo.note-activity.queue";
    // Binds the queue to every "note.*" routing key (note.created,
    // note.archived, note.tag_added, ...) published by NoteActivityProducer.
    public static final String ACTIVITY_ROUTING_KEY_PATTERN = "note.#";
    ...
    public Binding activityBinding() {
        return BindingBuilder.bind(activityQueue()).to(activityExchange()).with(ACTIVITY_ROUTING_KEY_PATTERN);
    }
}
