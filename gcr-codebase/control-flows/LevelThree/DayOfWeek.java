//Program to calculate the day of the week using command-line arguments
public class DayOfWeek {
    public static void main(String[] args) {
        //Taking month, day, year from command-line arguments
        ...
        //Printing result (0 = Sunday, 1 = Monday, ..., 6 = Saturday)
